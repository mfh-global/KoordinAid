...
<template>
    ...
    <div class="flex h-screen ">
        <div class="m-auto p-6 max-w-sm rounded-lg border shadow-md bg-gray-800 border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white">Hermine Webtools</h5>
            </a>
            <p class="mb-10 font-normal text-gray-400"></p>
